 ...
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJerseyServerCodegen", date = "2020-07-03T07:05:40.421Z")
public class AuthenticationResponse   {
  ...
  public AuthenticationResponse emailAdress(String emailAdress) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessToken, authenticationResponse.accessToken) &&
        ...
        Objects.equals(this.emailAdress, authenticationResponse.emailAdress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, expiresIn, userId, emailAdress);
  }
  ...
  public static AuthenticationResponse createFromApiToken(ApiToken token) throws ApiException {
    ...
    if (token.getUserAccount() == null) {
      throw new ApiException("Token user information is null");
    }
    return new AuthenticationResponse().accessToken(token.getAccessToken())
            .emailAdress(token.getUserAccount().getEmail()).expiresIn(600).userId(token.getUserAccount().getId());
  }
}
